...
const Banner = () => {
    return (
        <div className='container my-4 mx-auto flex justify-between rounded shadow gap-6'>
...
into today&apos;s plan, and watch the week&apos;s work add up.</p>
                <button className='text-sm font-bold rounded-2xl p-2 bg-[#CCFF00]'>BROWSE WORKOUTS</button>
            </div>
